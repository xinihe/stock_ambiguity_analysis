...
\begin{equation}
\mathcal{A}_t = -\sum_{i=1}^{N} \hat{w}_{i,t} \log(\hat{w}_{i,t})
\end{equation}
...
\begin{align}
R_{t} &= \alpha + c \cdot \Delta \text{GPR}_{t} + \gamma' \mathbf{X}_{t} + \epsilon_{t} \\
\Delta \mathcal{A}_{t} &= \alpha + a \cdot \Delta \text{GPR}_{t} + \theta' \mathbf{Z}_{t} + \eta_{t} \\
R_{t} &= \alpha + c' \cdot \Delta \text{GPR}_{t} + b \cdot \Delta \mathcal{A}_{t} + \gamma' \mathbf{X}_{t} + \epsilon_{t}
\end{align}
