...
\begin{highlightbox}
\textbf{Response:} We have added a sensitivity analysis examining robustness to alternative window specifications including 5-minute, 1-hour, and 1-day windows. The results confirm that the key findings are not driven by the specific window choice.
\end{highlightbox}
