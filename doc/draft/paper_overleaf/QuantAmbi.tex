...
\begin{itemize}
    ...
    \item \textbf{Ambiguity (CEA)}: \(\mathcal{A}^{CEA}_t\) is the ambiguity measure developed in this study. It accounts for short‑horizon informational instability using cross‑entropy between empirical intraday distributions and benchmark models. Higher values of \(\mathcal{A}^{CEA}_t\) indicate greater market uncertainty.
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{CEA (\(\mathcal{A}^{CEA}_t\)) Deciles}
