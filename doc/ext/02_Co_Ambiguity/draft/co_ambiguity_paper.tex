...
\begin{align}
SCA_t &= \alpha_0 + \sum_{l=1}^{L} \alpha_l SCA_{t-l} + \sum_{l=1}^{L} \beta_l Liquidity_{t-l} + \varepsilon_{1t} \\
Liquidity_t &= \gamma_0 + \sum_{l=1}^{L} \gamma_l SCA_{t-l} + \sum_{l=1}^{L} \delta_l Liquidity_{t-l} + \varepsilon_{2t}
\end{align}
...
\begin{equation}
\text{Crash}_{t+k} = \alpha + \beta_1 SCA_t + \beta_2 (SCA_t \times StructuralChange_t) + \beta_3 StructuralChange_t + \mathbf{\Gamma}'\mathbf{Controls}_t + \varepsilon_t,
\end{equation}
